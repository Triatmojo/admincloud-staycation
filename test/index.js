    ...
    it('POST Booking Page', (done) => {
        ...
        chai.request(app).post('/api/v1/member/booking-page')
          ...
          .end((err, res) => {
              ...
              expect(res.body.message).to.equal('Yeay, you success booking')
              expect(res.body).to.have.property('booking')
              expect(res.body.booking).to.have.all.keys('invoice', 'payments', 'itemId', '_id', 'bookingStartDate', 'bookingEndDate',  'total', 'memberId', '__v')
